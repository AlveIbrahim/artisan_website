interface SectionDividerProps {
  ...
  height?: 'sm' | 'md' | 'lg';
  backgroundColor?: 'sage' | 'terracotta' | 'soft-gray' | 'warm-white' | 'charcoal' | 'white';
}
...
export function SectionDivider({ 
  ...
  const curves = {
    ...
    curve1: "M0,96L1440,0L1440,96L0,96Z",
    curve2: "M0,0L1440,96L1440,0L0,0Z",
  };
  ...
  return (
    <div className={`relative ${flip ? 'transform rotate-180' : ''}`} style={backgroundColor ? { backgroundColor: colorMap[backgroundColor] } : {}}>
      <svg
